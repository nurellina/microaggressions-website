        ...
        <body>
            ...
            <div class="definition grid">
              <div class="def1">
                ...
                <p class="ff-accent-light">
                  {" "}
                  A microaggression is a <span class="ff-accent">
                    comment
                  </span>{" "}
              ...
              <div class="def3">
                <p>
                  ...
                  <span class="ff-accent clr-salmon">
                    {" "}
                    Chester M. Pierce
                  </span>{" "}
                  in the early 1970s.
              ...
              <div class="def4">
                <p>
                  ...
                  and women. Later became largely accepted as a way for people
                  to talk about a wide range of issues related to
                  discrimination, offense, and exclusion against any
                  marginalized group.
                </p>
              </div>
              <div class="def5">
          ...
          <article>
            <div class="container difference">
              ...
              <p>
                ...
                comments, or generalized jerky behavior.
                <br /> They're something very specific: the kinds of remarks,
                questions, or actions that are painful because they have to do
                with a person's membership in a group that's discriminated
                against or subject to stereotypes.
                <p>
                  And a key part of what makes them so disconcerting is that
                  they happen:
                </p>
              </p>
              <div class="grid">
              ...
              <p class="diff-par-position">
                ...
                sorts of things.
                <br /> And in fact, if you were to stop them and say, 'Why did
                you grab your purse when this person got closer?'
                <br />
          ...
          <article>
            <div class="container">
              ...
              <p>
                {" "}
                Microaggressions appear in a myriad of ways, they can be
                examined across many different dimensions of diversity, whether
                it be gender, sexuality, race, ethnicity, age, disability, and
                religion.
                <br />
              ...
              <p>
                ...
                <br />
                One of the reasons that microaggressions are expressed even
                though the speaker’s intention might be a good or benign one,
                is, that we all have unconscious (or implicit) biases
              </p>
            </div>
          </article>
          <section>
              ...
              <div class="split">
                <div class="column">
                  <p class="clr-white">
                    ...
                    to create a culture where people can openly discuss
                    sensitive topics, thinking more about the underlying
                    concepts and feelings and less about the specific words that
                    people use. However, we also agree that the subtle ways that
                    verbal and nonverbal acts serve to exclude people have real
                    and serious consequences, both in the moment and
                    cumulatively.”
                  </p>
                </div>
                <div class="column">
                  <p>
                    {" "}
                    Most of the time, such microinvalidations and aggressions
                    are disguised as humor. Often you might feel irritated and
